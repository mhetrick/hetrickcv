...
static float bipolarParamToOscillatorFrequencyScalar(float _bipolarParam)
{
...
static float bipolarParamToLFOFrequencyScalar(float _bipolarParam)
{
...
static float bipolarParamToClockMultScalar(float _bipolarParam)
{
