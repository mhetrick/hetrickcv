...
## 2.5.3 (In Progress)
- Add polyphony to 1-Op Chaos, 2-Op Chaos, 3-Op Chaos, ASR, Binary Gate, Binary Noise, Boolean Logic, Chaotic Attractors, Clocked Noise, Comparator, Crackle, Delta, Dust, Feedback Sine Chaos, Flip-Flop, Gingerbread Chaos, Rungler.
